 ...
 */
public class ShareAudioMedia implements IShareMedia {
    ...
    protected ShareAudioMedia(String title, String summary, String targetUrl, String imageUrl, String audioUrl) {
        this.title = title;
    ...
    public static class Builder{
        ...
        public ShareAudioMedia create(){
            ShareAudioMedia shareAudioMedia = new ShareAudioMedia(title,summary,targetUrl,imageUrl,audioUrl);
            return shareAudioMedia;
        }
    }
}
