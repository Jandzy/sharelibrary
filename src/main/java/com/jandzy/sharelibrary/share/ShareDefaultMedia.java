 ...
 */
public class ShareDefaultMedia implements IShareMedia {
    ...
    protected ShareDefaultMedia(String title, String summary, String targetUrl, String imageUrl) {
        this.title = title;
    ...
    public static class Builder{
        ...
        public ShareDefaultMedia create(){
            ShareDefaultMedia shareDefaultMedia = new ShareDefaultMedia(title,summary,targetUrl,imageUrl);
            return shareDefaultMedia;
        }
    }
}
